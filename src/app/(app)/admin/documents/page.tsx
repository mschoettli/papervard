...
export default async function AdminDocumentsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      <form action={bulkDocumentAction} className="rounded-lg border border-border bg-surface p-4">
        <div className="flex flex-col gap-3 lg:flex-row lg:items-end">
          <div className="min-w-0 flex-1">
            ...
            <select id="bulk-documents" name="documentId" multiple className="mt-1 h-32 w-full rounded-md border border-border bg-surface px-3 py-2 text-sm">
          ...
          <div className="flex flex-wrap gap-2">
            ...
            <button
              ...
              formMethod="get"
              className="inline-flex h-10 items-center justify-center gap-2 rounded-md border border-border bg-surface px-4 text-sm font-medium transition hover:bg-muted"
            >
              Herunterladen
            </button>
          </div>
